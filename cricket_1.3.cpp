...
int main()
{
    ...
    else if (ticket_cost == ticket_total_cost)
    {
        total_score++;
        cout << endl;
    ...
    else if (answer_2 >= min_answer_2 && answer_2 <= max_answer_2)
    {
        total_score++;
        cout << endl;
        cout << "Perfect! Now move on to the next question." << endl << endl;
    ...
    else if (answer_3 >= min_answer_3 && answer_3 <= max_answer_3)
    {
        total_score++;
        cout << endl;
    ...
    else if (answer_4 == correct_answer_4)
    {
        total_score++;
        cout << "Great! \n\n"
                "Game Over" << endl << endl;
    ...
    {
        case 1:
            cout << "Your correct answer ratio is " << percentage << "%" << endl << endl;
            break;
        case 2:
